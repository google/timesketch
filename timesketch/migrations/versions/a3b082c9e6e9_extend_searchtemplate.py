...
def upgrade():
    ...
    op.add_column('searchtemplate', sa.Column('short_name', sa.Unicode(length=255), nullable=True))
    op.add_column('searchtemplate', sa.Column('template_json', sa.UnicodeText(), nullable=True))
    op.add_column('searchtemplate', sa.Column('template_uuid', sa.Unicode(length=255), nullable=True))
    op.create_unique_constraint(None, 'searchtemplate', ['template_uuid'])
    op.add_column('view', sa.Column('searchtemplate_json', sa.UnicodeText(), nullable=True))
