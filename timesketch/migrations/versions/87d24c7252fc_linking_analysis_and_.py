...
def upgrade():
    ...
    with op.batch_alter_table('analysis', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('question_conclusion_id', sa.Integer(), nullable=True))
        batch_op.create_foreign_key(None, 'investigativequestionconclusion', ['question_conclusion_id'], ['id'])
        batch_op.create_foreign_key(None, 'investigativequestionapproach', ['approach_id'], ['id'])
