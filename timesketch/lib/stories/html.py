...
class HTMLStoryExporter(interface.StoryExporter):
    ...
    def export_story(self):
        ...
        return_strings.append(
            '<h1>{0:s}</h1>'.format(self._story_title))
        ...
        return_strings.append(
            ...
            '<li><b>Report Exported by:</b> {3:s}</li></ul>'.format(
                self._creation_date, self._story_author, date_now.isoformat(),
        ...
        for line_dict in self._data_lines:
            ...
            if line_type == 'text':
                return_strings.append(
                    md.convert(line_dict.get('value', '')))
                ...
                return_strings.append(
                    self._data_frame_to_html(line_dict.get('value')))
