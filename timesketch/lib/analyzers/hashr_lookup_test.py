...
class TestHashRLookupPlugin(BaseTest):
  ...
  def test_connect_hashr_conn_error(self, mock_info, mock_error,
    ...
    mock_create_engine().connect.side_effect = OperationalError(
    ...
    mock_error.assert_called_with(
        ...
        'hashR:***@127.0.0.2:5432/hashRdb -- Error message: Cannot connect to server!'
    )
  ...
  def test_check_against_hashR_matching_hashes_no_sources(
    ...
    mock_info.assert_any_call(self.logger, 'Found 5 unique hashes in hashR DB.')
