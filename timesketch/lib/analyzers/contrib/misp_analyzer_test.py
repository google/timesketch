...
class TestMisp(BaseTest):
    ...
    def setUp(self):
        ...
        self.MISP_ATTR = {"response": {"Attribute": [{"event_id":"5","category":"Payload delivery","type":"sha256","value":"ac7233de5daa4ab262e2e751028f56a7e9d5b9e724624c1d55e8b070d8c3cd09","Event":{"org_id":"1","id":"5","info":"Hash Test","uuid":"1f456b69-00c6-4fb0-8d92-709a0061b7d4"}},
        ...
        self.MATCHING_MISP = {"filename": "test.txt", "sha1_hash": "a308b3daed1711be6b1e591ba85984572a01134e", "sha256_hash": "ac7233de5daa4ab262e2e751028f56a7e9d5b9e724624c1d55e8b070d8c3cd09", "md5_hash": "e59c93a1fd36c70b37ef654d0603c30f"}
