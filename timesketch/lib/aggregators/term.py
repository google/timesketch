...
class FilteredTermsAggregation(interface.BaseAggregator):
    ...
    def run(
            ...
            filter_re='', keep_re_notfound=False, get_duration=None):
        """Run the aggregation.
        ...
        Args:
            ...
            get_duration (bool): get first, last date and duration of term value
        ...
        aggregation_spec = get_spec(
            field=formatted_field_name, limit=limit, order_type=order_type,
            query=query_string, query_dsl=query_dsl)
