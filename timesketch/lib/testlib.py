...
class TestConfig:
    ...
    DFIQ_ENABLED = False
    DATA_TYPES_PATH = "./tests/test_data/llm_prompts/nl2q_data_types.csv"
    PROMPT_NL2Q = "./tests/test_data/llm_prompts/nl2q_prompt.txt"
    EXAMPLES_NL2Q = "./tests/test_data/llm_prompts/nl2q_examples.txt"
