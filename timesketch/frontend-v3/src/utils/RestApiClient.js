...
export default {
  ...
  exportSketch(sketchId) {
    ...
    return RestApiBlobClient.post(
      "/sketches/" + sketchId + "/archive/",
      formData
    );
  },
  ...
  addSketchAttribute(sketchId, name, value, ontology) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/attribute/",
      attribute
    );
  },
  getSketchTimeline(sketchId, timelineId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/timelines/" + timelineId + "/"
    );
  },
  getSketchTimelineAnalysis(sketchId, timelineId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/timelines/" + timelineId + "/analysis/"
    );
  },
  ...
  createEvent(sketchId, datetime, message, timestampDesc, attributes, config) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/event/create/",
      formData,
      config
    );
  },
  ...
  tagEvents(sketchId, events, tags) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/event/tagging/",
      formData
    );
  },
  ...
  getView(sketchId, viewId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/views/" + viewId + "/"
    );
  },
  // Saved searches
  ...
  parseSearchTemplate(searchTemplateId, formData) {
    return RestApiClient.post(
      "/searchtemplates/" + searchTemplateId + "/parse/",
      formData
    );
  },
  // Search
  ...
  getSearchHistory(sketchId, limit = null, question = null) {
    ...
    return RestApiClient.get(
      "/sketches/" + sketchId + "/searchhistory/",
      params
    );
  },
  ...
  getAggregationById(sketchId, aggregationId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/aggregation/" + aggregationId + "/"
    );
  },
  ...
  runAggregator(sketchId, formData) {
    return RestApiClient.post(
      "/sketches/" + sketchId + "/aggregation/explore/",
      formData
    );
  },
  runAggregatorGroup(sketchId, groupId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/aggregation/group/" + groupId + "/"
    );
  },
  saveAggregation(sketchId, aggregation, name, formData) {
    let newFormData = {
      ...
      chart_type:
        formData["supported_charts"] ||
        formData["aggregator_parameters"]["chart_type"],
      parameters: formData,
    };
    return RestApiClient.post(
      "/sketches/" + sketchId + "/aggregation/",
      newFormData
    );
  },
  ...
  grantSketchAccess(sketchId, usersToAdd, groupsToAdd) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/collaborators/",
      formData
    );
  },
  ...
  getAnalyzerSession(sketchId, sessionId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/analyzer/sessions/" + sessionId + "/"
    );
  },
  getActiveAnalyzerSessions(sketchId) {
    ...
    return RestApiClient.get(
      "/sketches/" + sketchId + "/analyzer/sessions/active/",
      params
    );
  },
  // Graphs
  generateGraphFromPlugin(
    sketchId,
    graphPlugin,
    currentIndices,
    timelineIds,
  ...
  getSavedGraph(sketchId, graphId) {
    ...
    return RestApiClient.get(
      "/sketches/" + sketchId + "/graphs/" + graphId + "/",
      params
    );
  },
  // Sigma
  ...
  renameScenario(sketchId, scenarioId, scenarioName) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/scenarios/" + scenarioId + "/",
      formData
    );
  },
  setScenarioStatus(sketchId, scenarioId, status) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/scenarios/" + scenarioId + "/status/",
      formData
    );
  },
  getFacets(sketchId, scenarioId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/scenarios/" + scenarioId + "/facets/"
    );
  },
  ...
  getScenarioQuestions(sketchId, scenarioId) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/scenarios/" + scenarioId + "/questions/"
    );
  },
  ...
  createQuestionConclusion(sketchId, questionId, conclusionText) {
    ...
    return RestApiClient.post(
      "/sketches/" + sketchId + "/questions/" + questionId + "/conclusions/",
      formData
    );
  },
  ...
  getSessions(sketchId, timelineIndex) {
    return RestApiClient.get(
      "/sketches/" + sketchId + "/explore/sessions/" + timelineIndex + "/"
    );
  },
  getLoggedInUser() {
