              ...
              <div v-if="!selectedEvents.length">
                ...
                >
                  ...
                  <v-card class="pa-4">
                    ...
                    <v-card-actions>
                      <v-spacer></v-spacer>
                      <v-btn text @click="saveSearchMenu = false">
                        Cancel
                      </v-btn>
                      <v-btn
                        text
                ...
                <template>
                  ...
                  >
                    <v-icon title="Toggle event histogram"
                    ...
                    <v-list subheader two-line flat dense>
                      ...
                      <v-list subheader two-line flat>
                        ...
                        <v-list-item :ripple="false">
                          ...
                          <v-list-item-subtitle
                            >Show emojis</v-list-item-subtitle
                          >
                        </v-list-item>
                        <v-list-item :ripple="false">
                          <v-list-item-action>
...
export default {
  ...
  methods: {
    ...
    toggleDetailedEvent: function (row) {
      const selected = this.expandedRows.includes(row._id);

      if (selected) {
        row.showDetails = false;
        this.expandedRows = this.expandedRows.filter((id) => row._id !== id);
      } else {
        row.showDetails = true;
        this.expandedRows.push(row._id);
      }
    },
    ...
    paginate: function () {
      ...
      this.currentQueryFilter.from =
        this.tableOptions.page * this.currentQueryFilter.size -
