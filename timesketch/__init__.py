...
from timesketch.api.v1.resources import IndexResource
...
def create_app(config=None):
    ...
    api_v1.add_resource(SearchIndexResource, u'/searchindicies/')
    api_v1.add_resource(IndexResource, u'/index/')
