...
"""Intelligence API for version 1 of the Timesketch API."""
...
class TagMetadataResource(resources.ResourceMixin, Resource):
    """Resource to get tag metadata information."""
