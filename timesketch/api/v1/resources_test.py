...
class UploadFileResourceTest(BaseTest):
    ...
    def test_upload_file_with_plaso_filter(self):
        """Test uploading a file with a plaso filter."""
        with mock.patch("timesketch.lib.tasks.build_index_pipeline") as mock_build_pipeline:
    ...
    def test_upload_file_without_plaso_filter(self):
