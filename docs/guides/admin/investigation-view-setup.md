...
*   If you have an existing Timesketch deployment, please ensure to collect the
    latest version of the files in the [data](https://github.com/google/timesketch/tree/main/data)
    folder and [nginx.conf](https://github.com/google/timesketch/blob/main/contrib/nginx.conf).
